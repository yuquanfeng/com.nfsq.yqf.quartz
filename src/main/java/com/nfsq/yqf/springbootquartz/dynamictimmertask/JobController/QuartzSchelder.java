...
import com.nfsq.yqf.springbootquartz.dynamictimmertask.job.Job1;
import com.nfsq.yqf.springbootquartz.dynamictimmertask.job.Job2;
import org.quartz.*;
...
public class QuartzSchelder {
    ...
    public void startJob2() throws SchedulerException {
        // 通过JobBuilder构建JobDetail实例，JobDetail规定只能是实现Job接口的实例
        // JobDetail 是具体Job实例
